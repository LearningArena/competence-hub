...
export function usePagination(query, defaultNodeCount = 6, paginationContext) {
  ...
  const { ready, update, totalLoaded, setTotalLoaded, variables,setVariables, pageInfo, setPageInfo, pageNum, setPageNum, pageCursors, setPageCursors, activeFilters, isDescending, sortField, resetPagination } = useContext(paginationContext)
