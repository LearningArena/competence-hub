...
export const swedishStrings = {
  ...
  about: {
    ...
    background: 'Bakgrund',
    backgroundText: 'Kompetensmatchning utvecklades i samarbete med Göteborgsregionens kompetensnav, Västra Götalandsregionen och Business Region Göteborg med start 2020.',
    opensource: 'Öppen källkod',
    opensourceText: 'Koden för plattformen är öppen och finns tillgänglig här: https://github.com/LearningArena/competence-hub/edit/main/README.md',
    licens: 'Licens',
    licensText: 'Licensen för att använda källkoden är European Union Public Licence (EUPL) och kan bli hittat här https://joinup.ec.europa.eu/collection/eupl/eupl-guidelines-faq-infographics.',
  },
  faq: swedishFaq,
